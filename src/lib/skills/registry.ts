...
export const CORE_DOCUMENTS: CoreDocumentDefinition[] = [
  { type: "COMPANY_INTELLIGENCE", title: "Company Intelligence", agentType: "AI_CMO", purpose: "A factual company foundation covering the offer, category, business model, positioning, differentiators, proof, and brand signals.", skills: companyIntelligenceSkills, instructions: "Build the reusable company source of truth. Separate direct website evidence, public discovery, and hypotheses. Include offer architecture, positioning, proof, brand voice, messaging guardrails, known unknowns, and source notes." },
  { type: "SEO_AUDIT", title: "SEO Audit", agentType: "SEO", purpose: "A prioritized technical, on-page, content, schema, sitemap, SXO, and performance audit governed by the main SEO audit skill.", skills: seoAuditSkills, instructions: "Follow the main seo-audit skill first, then apply each specialist in chain order. Never claim indexation, rankings, traffic, or backlinks without official connected data. Produce evidence, severity, owner, effort, dependency, and a falsifiable success check for every priority." },
  { type: "GEO_AUDIT", title: "GEO and AI Visibility Audit", agentType: "GEO", purpose: "AI-search readiness, entity clarity, citability, and answer coverage grounded in established search fundamentals.", skills: geoAuditSkills, instructions: "Evaluate entity clarity, answer passages, question coverage, evidence density, structured-data support, and third-party source opportunities. Do not invent AI citations or treat readiness as an official platform metric." },
  { type: "COMPETITOR_ANALYSIS", title: "Competitor Analysis", agentType: "COMPETITOR", purpose: "A source-linked competitive landscape, alternative set, search posture, and positioning-whitespace report.", skills: competitorAnalysisSkills, instructions: "Run the ordered chain from company and audience foundation through SCOUT analysis and alternatives, then use analytics-and-reporting as the final report skill. Identify at least six real direct competitors from official company websites; if the niche is narrow, expand to genuine adjacent or indirect alternatives. For each, provide the company name, official website, 1-2 sentence positioning, and the specific attributes on which it competes. Never fabricate a name or use private performance. Build comparisons only from public category, audience, offer, proof, and content evidence." },
  { type: "AUDIENCE_ANALYSIS", title: "Audience and ICP Research", agentType: "AUDIENCE", purpose: "Evidence-backed ICPs, jobs-to-be-done, pains, objections, triggers, decision roles, and voice-of-customer language.", skills: audienceAnalysisSkills, instructions: "Create one to three sharp segments, separating buyer, user, and follower where necessary. Quote only customer language present in source evidence. Mark every inferred audience statement as a hypothesis and specify how to validate it." },
  { type: "CONTENT_AUDIT", title: "Content Audit and Strategy", agentType: "CONTENT_AUDIT", purpose: "A content inventory, quality audit, pillar map, topic gaps, briefs, and measurable editorial direction.", skills: contentAuditSkills, instructions: "Audit supplied content for coverage, depth, proof, buyer-stage balance, duplication, and freshness. Produce keep, refresh, consolidate, and create decisions, then define pillars, clusters, briefs, and measurement rules." },
];

export const EXTENDED_DOCUMENTS: CoreDocumentDefinition[] = [
  { type: "MARKETING_STRATEGY", title: "Integrated Marketing Strategy", agentType: "CAMPAIGN_PLANNER", purpose: "A complete evidence-led marketing strategy connecting positioning, priorities, channels, campaigns, measurement, and operating rhythm.", skills: marketingStrategySkills, instructions: "Produce an executive thesis, audience and positioning choices, objectives, channel roles, campaign architecture, 30/60/90-day plan, KPIs, dependencies, risks, confidence, and source register." },
  { type: "DESIGN_GUIDE", title: "Brand and Visual Design Guide", agentType: "CREATIVE_VISUAL", purpose: "A production-ready brand expression and campaign design system grounded in observed brand evidence.", skills: designGuideSkills, instructions: "Cover aesthetic principles, color roles, typography, spacing, composition, imagery, iconography, data visualization, social templates, accessibility, examples, asset checklist, and production QA. Label observed evidence versus proposed extensions." },
  { type: "CONTENT_STRATEGY", title: "Full-Funnel Content Strategy", agentType: "CONTENT_AUDIT", purpose: "A detailed editorial, search, distribution, repurposing, calendar, and measurement system.", skills: contentStrategySkills, instructions: "Connect every asset to an audience, decision, proof requirement, native format, distribution flow, owner, KPI, and refresh trigger. Finish with a prioritized 90-day backlog." },
  { type: "PRODUCT_INFO", title: "Offer and Product Intelligence", agentType: "AI_CMO", purpose: "A detailed offer architecture, value proposition, proof, objections, use cases, packaging hypotheses, and sales-enablement foundation.", skills: productInfoSkills, instructions: "Cover offer hierarchy, jobs, use cases, differentiators, proof, objections, buying questions, packaging and pricing evidence, sales narratives, gaps, validation plan, and source register. Never invent commercial metrics." },
];
...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
  ...
  { type: "X", label: "X Agent", optional: false, description: "A concise account readout, new posts, and sourced reply opportunities.", skills: [...socialFoundation, skill("social-media-skills", "x-growth", "analysis", "Apply current X-native growth mechanics."), skill("social-media-skills", "thread-writer", "production", "Create structured thread concepts."), skill("social-media-skills", "hook-writer", "production", "Strengthen opening lines without clickbait."), sourceQuality], instructions: "Start with a short current-status summary. Summarize discovered recent company posts without claiming complete history, create two publish-ready X posts, and find two sourced conversations where the company can add a useful reply. Every reply opportunity must include a complete recommendedResponse in the company's voice. Never invent trends, engagement, or metrics." },
  { type: "REDDIT", label: "Reddit Customer Research", optional: false, description: "A concise customer-signal readout with sourced threads and safe, useful response drafts.", skills: [...socialFoundation, skill("social-media-skills", "audience-research", "research", "Identify target-customer jobs, pains, objections, and actual language."), skill("social-media-skills", "reddit-marketing", "analysis", "Apply the advisory-only CRED framework and subreddit safeguards."), skill("social-media-skills", "community-management", "production", "Recommend credible manual participation and escalation boundaries."), skill("social-media-skills", "ai-search-optimization", "analysis", "Assess source-layer relevance without fabricated citation claims."), sourceQuality], instructions: "Start with a short current-status summary. Use current public Reddit threads to find likely target customers for the submitted company URL. Produce at least three kind=comment_opportunity findings. For each, identify the suspected segment, job-to-be-done, pain or buying intent, exact source language, offer fit, subreddit or thread, tags, and a complete transparent non-promotional recommendedResponse that can be edited and copied. Do not identify private individuals, automate posting, use alts, manipulate votes, or present public search as authenticated Reddit data." },
  ...
  { type: "LINKEDIN", label: "LinkedIn Agent", optional: false, description: "A concise page readout, previous-post summary, new drafts, and comment opportunities.", skills: [...socialFoundation, skill("social-media-skills", "linkedin-growth", "analysis", "Apply personal-profile LinkedIn growth strategy."), skill("social-media-skills", "linkedin-company-pages", "analysis", "Route company-page work appropriately."), skill("social-media-skills", "linkedin-post-writer", "production", "Create native LinkedIn drafts."), skill("social-media-skills", "carousel-writer", "production", "Create a document-carousel brief."), sourceQuality], instructions: "Start with a short current-status summary. Summarize up to three recent company posts found through current public discovery and explicitly state when authenticated history is unavailable. Then create at least two publish-ready native LinkedIn posts in draftContent and identify at least two sourced third-party posts where the company can comment. Each comment opportunity must include a complete thoughtful recommendedResponse, not merely advice to comment. Do not invent post history, engagement, people, or metrics." },
