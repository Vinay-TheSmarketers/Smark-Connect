...
export type SkillRepository = "claude-seo" | "openclaw-marketing-skills" | "social-media-skills" | "local";
...
const socialBatchPublishingSkills = mergeSkillChains(socialBatchPlanSkills, [
  skill("social-media-skills", "brand-profile", "foundation", "Apply the approved brand and visual foundation."),
  skill("social-media-skills", "voice-builder", "foundation", "Keep every channel in a consistent, credible voice."),
  skill("local", "live-conversation-mining", "research", "Identify current conversations and audience language worth responding to."),
  skill("social-media-skills", "linkedin-post-writer", "production", "Create native LinkedIn drafts."),
  skill("social-media-skills", "reels-script", "production", "Create short-form video concepts from the batch plan."),
  skill("social-media-skills", "story-writer", "production", "Create interactive Story sequences."),
  skill("social-media-skills", "cross-platform-repurposing", "quality", "Adapt each idea natively across social channels."),
  sourceQuality,
]);
const shortFormVideoUgcSkills = mergeSkillChains(shortFormVideoSkills, [
  skill("social-media-skills", "brand-profile", "foundation", "Apply the approved brand and visual foundation."),
  skill("social-media-skills", "voice-builder", "foundation", "Keep creator scripts natural and on-brand."),
  skill("social-media-skills", "ugc-and-influencer", "analysis", "Apply UGC authenticity, usage rights, and disclosure safeguards."),
  sourceQuality,
]);
...
const brandStorytellingSkills = [
  ...
  skill("social-media-skills", "storytelling-and-narrative", "production", "Write compelling case study narratives and customer proof points."),
];
