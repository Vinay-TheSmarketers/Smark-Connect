...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
  ...
  { type: "CREATIVE_VISUAL", label: "Creative and Visual Agent", optional: true, description: "On-brand campaign visual systems and production briefs.", skills: [...designGuideSkills, skill("local", "visual-report-composition", "production", "Apply publication-grade visual and hierarchy composition rules.")], instructions: "Define one cohesive visual direction and three production-ready asset briefs grounded in observed brand evidence and validated platform specifications." },
